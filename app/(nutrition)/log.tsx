...
const styles = StyleSheet.create({
  ...
  aiBadge: { position: 'absolute', top: -5, right: -5, width: 24, height: 24, borderRadius: 12, backgroundColor: '#D4F93D', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#FFF' }
});